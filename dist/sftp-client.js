...
export class SFTPClient {
    ...
    async connect(options) {
        try {
            ...
            console.error('SFTPClient: Error connecting to SFTP server:', error);
    ...
    async cd(remoteDir) {
        try {
            ...
            console.log(`SFTPClient: current directory set to ${this.currentDir}`);
        }
        catch (error) {
    ...
    async pwd() {
        try {
            ...
            console.error('SFTPClient: Error retrieving current directory:', error);
